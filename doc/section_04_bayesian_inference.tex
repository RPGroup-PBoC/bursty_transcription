...
model is incapable of fitting the data. We will verify that this is in fact the
...
meaning they are underdispersed relative to the Poisson distribution. We will also not explicitly
...
predictive checks}. This consists in generating synthetic data using our
...
samples drawn from a Poisson distribution with  $\lambda$ chosen appropriately. We then repeat
