...
\fig{fig1:means_cartoons} depicts a smorgasbord of mathematized cartoons for
...
= \left(1 + \frac{R}{N_{NS}} e^{-\beta\Delta\epsilon_R}\right)^{-1},
\end{equation}
which clearly matches the form of the master curve in~\eq{fig1:means_cartoons}
with $\rho=1$.
...
Now we consider model 3 in~\eq{fig1:means_cartoons} which allows the possibility
...
in~\fig{fig1:means_cartoons}B so long as the repressor binding is exclusive with
