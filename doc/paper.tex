...
along with literature references to their prior usage.
...
(4) a more coarse-grained version of (2) where the precise nature
of active and inactive states are left ambiguous~\mmnote{Cite Manuel}, and
(5) transcripts are produced in bursts,
...
distribution has variance to squared mean ratio
...
from elevating to a ``theorem'' this cycle/sub-Poissonian equivalence.
...
\mmnote{find a good cite for this usage},
