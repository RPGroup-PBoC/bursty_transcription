...
Appendix~\ref{sec:non_bursty}. What we will find is that
for all cartoons the fold-change can be written as a Fermi function 
\begin{equation}
...
promoter, and the promoter details. This is \mrm{This is based in one of the
comments from reviewer \# 2. It is empirically true for all models we explored,
but I don't know how to prove that it is a general statement for any
unimaginable complex model.}
\begin{align}
...
% kinetic model 4 in~\fig{fig1:means_cartoons}(C), with zero repressor
