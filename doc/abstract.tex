...
thinking, can be used to derive the predicted levels of gene expression. These
different models are invoked to confront a variety of different data on mean,
variance and full gene expression distribution, illustrating the extent to which
such models can be distinguished, and suggesting a two-state model with a distribution
of burst sizes as the most potent of the seven for describing the simple-repression motif.
\end{abstract}