...
\item MCMC.
Lot's of fun and deep analogies to stat mech and
Hamiltonian mechanics we'll allude to but not explore here.
The idea of MCMC: in a perfect world, you'd
...
PPC is essential to verify that your model is
not blatantly contradicted by the data.
\end{itemize}
}
...
\mmnote{Outline:
Perhaps urprising that so many model parameters can be inferred from just a few
